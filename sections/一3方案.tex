...
从图\subref*{fg:bar_1}中可以看出在均布节点的离散情况下，拉格朗日乘子型时空混合伽辽金弱形式无需分块网格技术，即可得到稳定的数值结果。图\subref*{fg:bar_2}也可以看出该混合离散框架可以保证理论误差收敛率。
...
\begin{figure}[!h]
    ...
    \subfloat[四面体柱积分域]{\includegraphics[width=0.4\textwidth]{figures/tetraprism.png}\label{fg:bar_1}}
    \hspace{24pt}
    \subfloat[六面体柱积分域]{\includegraphics[width=0.4\textwidth]{figures/cubeprism.png}\label{fg:bar_2}}
    \caption{四维空间背景积分域}
    \label{fg:bar}
\end{figure}
